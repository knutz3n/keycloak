...
public class DefaultLocaleSelectorProvider implements LocaleSelectorProvider {
    ...
    protected Locale getUserLocale(RealmModel realm, UserModel user, HttpHeaders requestHeaders, UriInfo uriInfo) {
        ...
        final LocaleSelection cookieSelection = getCookieSelection(realm, requestHeaders);
        if (cookieSelection != null) {
            if (user != null) {
                updateUsersLocale(user, cookieSelection.getLocaleString());
            }
            return cookieSelection.getLocale();
        }
        ...
        return getAcceptLanguageHeaderLocale(realm, requestHeaders).getLocale();
    }
    ...
    protected LocaleSelection getCookieSelection(RealmModel realm, HttpHeaders httpHeaders) {
